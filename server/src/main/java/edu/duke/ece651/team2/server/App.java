...
public class App {
  ...
  private ConcurrentHashMap<Integer, CacheForLecture> lectureCacheMap = new ConcurrentHashMap<>();
  ...
  public void connectToClients() throws ClassNotFoundException, GeneralSecurityException {
    try {
      ...
      while (true) {
        ...
        serverSideController = new ServerSideController(serverSideView, lectureCacheMap);
